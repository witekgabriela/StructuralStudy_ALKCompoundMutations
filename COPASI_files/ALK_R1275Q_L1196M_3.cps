...
<!-- generated with COPASI 4.27 (Build 217) (http://www.copasi.org) at 2022-10-04T18:36:41Z -->
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5368" name="k1" value="26.71"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5367" name="k1" value="6.3154e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5365" name="k1" value="6.3154e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2022-10-04T18:34:17Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 Drug Binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 Drug Binding],ParameterGroup=Parameters,Parameter=k1" value="69400000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 ATP Binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 ATP Binding],ParameterGroup=Parameters,Parameter=k1" value="69400000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 Drug Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 Drug Disc],ParameterGroup=Parameters,Parameter=k1" value="26.710000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 ATP Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 ATP Disc],ParameterGroup=Parameters,Parameter=k1" value="6315400" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E2 ATP Binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E2 ATP Binding],ParameterGroup=Parameters,Parameter=k1" value="69400000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E2 ATP Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E2 ATP Disc],ParameterGroup=Parameters,Parameter=k1" value="6315400" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2022-10-04T18:34:16Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
