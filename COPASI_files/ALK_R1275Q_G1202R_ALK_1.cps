...
<!-- generated with COPASI 4.27 (Build 217) (http://www.copasi.org) at 2022-08-25T14:18:06Z -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3415" name="k1" value="8.14e+10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4630" name="k1" value="8.14e+10"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8185" name="k1" value="90.5"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8172" name="k1" value="4.477e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_8172"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3800" name="k1" value="8.14e+10"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8066" name="k1" value="4.477e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3927" name="k1" value="1e+08"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3928" name="k1" value="3.84e+08"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2022-08-25T14:17:07Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 Drug Binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 Drug Binding],ParameterGroup=Parameters,Parameter=k1" value="81400000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 ATP Binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 ATP Binding],ParameterGroup=Parameters,Parameter=k1" value="81400000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 Drug Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 Drug Disc],ParameterGroup=Parameters,Parameter=k1" value="90.5" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 ATP Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E1 ATP Disc],ParameterGroup=Parameters,Parameter=k1" value="4477000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E2 ATP Binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E2 ATP Binding],ParameterGroup=Parameters,Parameter=k1" value="81400000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E2 ATP Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_G1202R_Lor_ATP,Vector=Reactions[E2 ATP Disc],ParameterGroup=Parameters,Parameter=k1" value="4477000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
