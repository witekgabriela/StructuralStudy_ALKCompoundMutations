...
<!-- generated with COPASI 4.27 (Build 217) (http://www.copasi.org) at 2022-08-25T14:20:38Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_0" name="ALK_R1275Q_L1196M_Lor_ATP" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3607" name="k1" value="8.14e+10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5686" name="k1" value="8.14e+10"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5699" name="k1" value="50.71"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5708" name="k1" value="7.4074e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_12">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5879" name="k1" value="8.14e+10"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_13">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8102" name="k1" value="7.4074e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_8102"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_14">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4071" name="k1" value="1e+08"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_15">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8358" name="k1" value="3.41e+08"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2022-08-25T14:18:06Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 Drug Disc]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Reactions[E1 Drug Disc],ParameterGroup=Parameters,Parameter=k1" value="50.710000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_2" associatedEntityKey="Task_11" objectCN="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=InitialConcentration" objectType="float" objectValue="0.001" minValue="0" maxValue="2" tickNumber="1000" tickFactor="100" scaling="linear"/>
      <Slider key="Slider_3" associatedEntityKey="Task_12" objectCN="CN=Root,Model=ALK_R1275Q_L1196M_Lor_ATP,Vector=Compartments[compartment],Vector=Metabolites[L],Reference=InitialConcentration" objectType="float" objectValue="1e-10" minValue="0" maxValue="0.0001" tickNumber="1000" tickFactor="100" scaling="linear"/>
    </ListOfSliders>
  </GUI>
